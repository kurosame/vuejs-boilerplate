...
test('Call the commit of the ADD_VALUE', () => {
...
test('Call the commit of the AXIOS_SAMPLE', done => {
...
test('Output the console.error of the AXIOS_SAMPLE', done => {
  moxios.stubRequest('/api', {
    status: 400
  })
...
test('Call the commit of the ASYNC_AWAIT_SAMPLE', done => {
  moxios.stubRequest('/api', {
    status: 200,
...
test('Output the console.error of the ASYNC_AWAIT_SAMPLE', done => {
  moxios.stubRequest('/api', {
    status: 400
  })
